                ...
                <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                  ...
                  <div className='relative p-6 flex-auto my-4 text-black text-lg leading-relaxed'>
                    <form>
                      ...
                      <input
                        placeholder='Eg: 0'
                        className='border-solid border my-2 mx-2 border-black px-2'
                        value={newCompanyID}
                        onChange={(e) => {
                      ...
                      <input
                        placeholder='Eg: 17/03/2021'
                        className='border-solid border mx-2 border-black px-2'
                        value={newStartDate}
                        onChange={(e) => {
                      ...
                      <input
                        placeholder='Eg: 28/09/2022'
                        className='border-solid border my-2 border-black px-2'
                        value={newEndDate}
                        onChange={(e) => {
                      ...
                      <input
                        ...
                        className='border-solid border border-black px-4 mx-8 my-3'
                        value={newRole}
                        onChange={(e) => {
