                ...
                <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                  ...
                  <div className='relative p-6 flex-auto my-4 text-black text-lg leading-relaxed'>
                    <form className='mx-auto'>
                      ...
                      <input
                        placeholder='Eg: Blockchain Technology'
                      ...
                      <select
                        ...
                        <option selected value='udemy'>Udemy</option>
                        <option value='Coursera'>Coursera</option>
                        <option value='A C Patil'>
                          A C Patil
                        </option>
                      ...
                      <label>Link:</label>
                      <input
                        placeholder='Eg:udemy.com/sohail0193/blockchain_development'
                        required
                  ...
                  <div className='flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b'>
                    <button
                      className='text-red-500 background-transparent font-bold uppercase border-2 border-black px-6 py-2 text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                      type='button'
                      onClick={() => setShowModal(false)}>
                      Close
                    </button>
                    <button
                      className='bg-emerald-500 border-2 border-black text-black active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                      type='button'
