...
function Profile() {
  ...
  useEffect(() => {
    ...
    // ) {
    //   alert("Oops, Seems like you are not logged in to this account");
    //   history.push("/");
    // }
    // if (
      ...
      <div className="w-2/6 h-full flex flex-row justify-end">
        <div className="border-black w-36 h-36 border-solid rounded-full bg-gray-500">
          <div className="text-7xl text-center p-6">
            ...
            <img
                        className="h-50 w-60 rounded-full"
                        src="https://pbs.twimg.com/profile_images/1399434781788573701/hyTg_9uI_400x400.jpg"
                        alt=""
                      />
          </div>
        </div>
        <div className={style}>
          <button
            className={
              "bg-blue-800 inline text-white active:bg-blue-800 font-bold uppercase text-sm px-4 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            }
            type="button"
